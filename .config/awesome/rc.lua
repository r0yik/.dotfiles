...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, ctrlkey }, "r", awful.tag.history.restore,
    ...
    -- Cycle layout
    awful.key({ modkey, ctrlkey }, "space", function() awful.layout.inc(1) end,
        { description = "select next", group = "layout" }),
    awful.key({ modkey, ctrlkey, shiftkey }, "space", function() awful.layout.inc(-1) end,
    ...
    awful.key({ modkey, shiftkey }, "d", function() awful.tag.incnmaster(-1, nil, true) end,
        { description = "decrease the number of master clients", group = "layout" }),
    awful.key({ modkey, shiftkey }, "a", function() awful.tag.incncol(1, nil, true) end,
        { description = "increase the number of columns", group = "layout" }),
    awful.key({ modkey, shiftkey }, "o", function() awful.tag.incncol(-1, nil, true) end,
        { description = "decrease the number of columns", group = "layout" }),

    awful.key({ modkey, shiftkey }, "0",
        function()
